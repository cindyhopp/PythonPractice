...
environ['PROJ_LIB'] = 'C:\\Users\\W0305076\\.conda\\envs\\prog5000\\Library\\share\\proj'
...
class TestBoundingBox(unittest.TestCase):
    ...
    def test_transform_to(self):
        ...
        box = bbox.BoundingBox('BBOX-1', 329000.0, 4972000.0, 330000.0, 4973000.0, crs)
        # CRS that we will transform to
        epsg4617 = CRS.from_epsg(4617)
        box.transform_to(epsg4617)
        # The CRS should now be epsg4617
        self.assertTrue(box.crs == epsg4617)
        # Test the coordinates
        self.assertEqual(44.880895860232485, box.xmin)
        self.assertEqual(-65.16514569988556, box.ymin)
        self.assertEqual(44.890130890718865, box.xmax)
        self.assertEqual(-65.1528286442206, box.ymax)
